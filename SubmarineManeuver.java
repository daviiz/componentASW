 ...
 */
public class SubmarineManeuver extends ViewableDigraph {

	private ViewableAtomic updater;
	private ViewableAtomic actor;

	// Add Default Constructor
	public SubmarineManeuver() {
		this("pManeuver_0_0");
	}

	// Add Parameterized Constructors
	public SubmarineManeuver(String name) {
		super(name);
...
//add test input ports:
		...
		updater = new SubmarineManeuver_Updater("updater");
		actor = new SubmarineManeuver_Actor("actor");
