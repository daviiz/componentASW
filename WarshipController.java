 ...
 */
public class WarshipController extends ViewableDigraph {
	...
	public WarshipController(String name) {
		super(name);
...
//add test input ports:
		...
		updater = new WarshipController_Updater("updater");
		actor = new WarshipController_Actor("actor");
