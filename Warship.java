 ...
 */
public class Warship extends ViewableDigraph{
    ...
    public Warship(String name,int x,int y, int speed){
        super(name);
...
//add test input ports:
        ...
        // Initialize sub-components
         pManeuver =  new WarshipManeuver("WarshipManeuver");
         pController =  new WarshipController("WarshipController");
         pSensor =  new WarshipSensor("WarshipSensor");
...
// Structure information end
    ...
    public void layoutForSimView() {
		...
		((ViewableComponent) withName("WarshipManeuver")).setPreferredLocation(new Point(40, 330));
		((ViewableComponent) withName("WarshipController")).setPreferredLocation(new Point(20, 165));
		((ViewableComponent) withName("WarshipSensor")).setPreferredLocation(new Point(0, 15));
	}
