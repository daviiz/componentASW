 ...
 */
public class SubmarineSensor_Actor extends ViewableAtomic {

	private double tCYCLE = 2;
	...
	public SubmarineSensor_Actor() {
		this("Sensor_Actor");
	}

	// Add Parameterized Constructors
	public SubmarineSensor_Actor(String name) {
		super(name);
...
// Structure information end
	...
	public void deltint() {
		if (phaseIs("DETECT")) {
			track_info_ent = OM_Sensor.Detection_Algorithm("submarine");
			holdIn("PERIOD", tCYCLE);
