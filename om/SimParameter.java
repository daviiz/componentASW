...
public class SimParameter {
	...
	/**
	 * (knts) ,The movement speed of the surface ship.
	 * 1 Knot = 0.51444444 Meters per Second.
	 * */
	...
	/**
	 * (knts) Low speed:18, Middle speed:23, High speed:35,
	 * The different speed is applied according to the pattern of torpedo movement.
	 * */
	...
	////////////////Decoy
	/**
	 * The motion types are mobile and static decoy.
	 * 1: static
	 * 2: mobile
	 * */
	public static int Motion_type_Decoy = 1; 
	/**
	 *The launch types are rocket and air pressed.
	 * 1 : rocket
	 * 2 : air pressed  
	 * */
	...
	/**
	 *  (%) The probability of working normally
