 ...
 */
public class WarshipSensor extends ViewableDigraph {
	...
	public WarshipSensor(String name) {
		super(name);
...
//add test input ports:
		...
		updater = new WarshipSensor_Updater("updater");// 收集存储探测信息
		actor = new WarshipSensor_Actor("actor");// 提供探测算法
